...
import { StoreImageResponse } from '../models/storeImageResponse';
import { StoreVideoResponse } from '../models/storeVideoResponse';
...
export class MediaStorageService {
  ...
  public configuration = new Configuration();
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public storeImageForm(file: Blob, observe?: 'body', reportProgress?: boolean): Observable<StoreImageResponse>;
    public storeImageForm(file: Blob, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StoreImageResponse>>;
    public storeImageForm(file: Blob, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StoreImageResponse>>;
    public storeImageForm(file: Blob, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<StoreImageResponse>('post',`${this.basePath}/media/storeImage`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public storeVideoForm(file: Blob, observe?: 'body', reportProgress?: boolean): Observable<StoreVideoResponse>;
    public storeVideoForm(file: Blob, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StoreVideoResponse>>;
    public storeVideoForm(file: Blob, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StoreVideoResponse>>;
    public storeVideoForm(file: Blob, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<StoreVideoResponse>('post',`${this.basePath}/media/storeVideo`,
            {
                body: convertFormParamsToString ? formParams.toString() : formParams,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
