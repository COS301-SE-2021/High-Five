...
public class DJIActivity extends AppCompatActivity {
    ...
    private static final String TAG = DJIActivity.class.getName();
    public static final String FLAG_CONNECTION_CHANGE = "dji_sdk_connection_change";
    private static BaseProduct mProduct;
    private Handler mHandler;
    /**
     * Array of strings containing the required permissions.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_djiactivity);
