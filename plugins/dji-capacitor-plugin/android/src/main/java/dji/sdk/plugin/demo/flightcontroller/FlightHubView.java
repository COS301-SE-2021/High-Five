...
public class FlightHubView extends LinearLayout implements PresentableView, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.fh_bind_aircraft) {
            bindAircraft();
        } else if (id == R.id.fh_unbind_aircraft) {
            unbindAircraft();
        } else if (id == R.id.fh_get_team_info) {
            getTeamInfo();
        } else if (id == R.id.fh_check_live_stream_stability) {
            checkLiveStreamStability();
        } else if (id == R.id.fh_get_flight_statistics) {
            getFlightStatistics();
        } else if (id == R.id.fh_get_stream_source) {
            getStreamSource();
        } else if (id == R.id.fh_get_stream_destination) {
            getStreamDestination();
        } else if (id == R.id.fh_get_streaming_devices) {
            getStreamingDevices();
        } else if (id == R.id.fh_get_online_devices) {
            getOnlineDevices();
        } else if (id == R.id.fh_get_real_time_data) {
            getRealTimeData();
        } else if (id == R.id.fh_get_flight_path) {
            getFlightPath();
        } else if (id == R.id.fh_start_upload_flight_data) {
            startUploadFlightData();
        } else if (id == R.id.fh_stop_upload_flight_data) {
            stopUploadFlightData();
        } else if (id == R.id.fh_set_upload_interval) {
            setUploadInterval();
        } else if (id == R.id.fh_get_upload_interval) {
            getUploadInterval();
        }
    }
