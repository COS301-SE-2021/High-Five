...
import dji.sdk.plugin.audiohandler.AudioDecoder;
import dji.sdk.plugin.audiohandler.MediaRecorderHandler;
import dji.sdk.plugin.audiohandler.MediaRecorderOptions;
import dji.sdk.plugin.utils.GeneralUtils;
...
public class AudioFileListManagerView extends LinearLayout implements View.OnClickListener, PresentableView {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_stop_playing) {
            stopPlaying();
        } else if (id == R.id.btn_start_record) {
            startRecord();
        } else if (id == R.id.btn_stop_record) {
            stopRecord();
        } else if (id == R.id.btn_upload_local_file) {
            startTransmitFile();
        } else if (id == R.id.btn_cancel_transmitting) {
            cancelTransmitting();
        } else if (id == R.id.btn_fetch_playlist) {
            fetchFileList();
        }
    }
