package dji.sdk.plugin.demo.firmwareupgrade;
...
public class FirmwareUpgradeView extends LinearLayout implements View.OnClickListener, PresentableView {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_start_consistent_upgrade) {
            startFirmwareConsistencyUpgradeWithCompletion();
        } else if (id == R.id.btn_stop_consistent_upgrade) {
            stopFirmwareConsistencyUpgradeWithCompletion();
        } else if (id == R.id.btn_get_upgrade_state) {
            getCurrentUpgradeFirmwareState();
        } else if (id == R.id.btn_get_current_firmware_info) {
