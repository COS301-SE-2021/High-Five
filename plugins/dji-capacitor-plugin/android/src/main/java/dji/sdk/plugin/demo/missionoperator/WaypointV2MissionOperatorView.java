package dji.sdk.plugin.demo.missionoperator;
...
import dji.sdk.plugin.demo.missionmanager.MissionBaseView;
...
public class WaypointV2MissionOperatorView extends MissionBaseView {
   ...
   // Global variables for waypointV2Action
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.btn_set_maximum_altitude) {
        ...
        } else if (id == R.id.btn_set_maximum_radius) {
