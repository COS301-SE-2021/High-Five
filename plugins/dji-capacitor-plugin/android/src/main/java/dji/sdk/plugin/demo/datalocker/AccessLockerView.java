package dji.sdk.plugin.demo.datalocker;
...
public class AccessLockerView extends LinearLayout implements View.OnClickListener, PresentableView {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_get_user_account) {
            getUserAccount();
        } else if (id == R.id.btn_get_version) {
            getVersion();
        } else if (id == R.id.btn_set_up_user_account) {
            setUpUserAccount();
        } else if (id == R.id.btn_login) {
            login();
        } else if (id == R.id.btn_reset_user_account) {
            resetUserAccount();
        } else if (id == R.id.btn_modify_user_account) {
            modifyUserAccount();
