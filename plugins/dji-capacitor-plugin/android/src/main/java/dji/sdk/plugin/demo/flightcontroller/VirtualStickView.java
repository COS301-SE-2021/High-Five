...
public class VirtualStickView extends RelativeLayout
    ...
    public void onClick(View v) {
        ...
        int id = v.getId();
        if (id == R.id.btn_enable_virtual_stick) {
        ...
        } else if (id == R.id.btn_disable_virtual_stick) {
        ...
        } else if (id == R.id.btn_roll_pitch_control_mode) {
            if (rollPitchControlModeFlag) {
        ...
        } else if (id == R.id.btn_yaw_control_mode) {
        ...
        } else if (id == R.id.btn_vertical_control_mode) {
        ...
        } else if (id == R.id.btn_horizontal_coordinate) {
            if (horizontalCoordinateFlag) {
