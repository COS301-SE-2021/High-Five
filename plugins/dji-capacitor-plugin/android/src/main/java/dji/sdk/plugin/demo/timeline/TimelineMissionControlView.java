package dji.sdk.plugin.demo.timeline;
...
public class TimelineMissionControlView extends LinearLayout implements OnClickListener, PresentableView {
    ...
    public void onClick(View v) {
        ...
        int id = v.getId();
        if (id == R.id.btn_timeline_init) {
            initTimeline();
        } else if (id == R.id.btn_timeline_start) {
            startTimeline();
        } else if (id == R.id.btn_timeline_stop) {
            stopTimeline();
        } else if (id == R.id.btn_timeline_pause) {
            ...
            pauseTimeline();
        } else if (id == R.id.btn_timeline_resume) {
            ...
            resumeTimeline();
        } else if (id == R.id.btn_timeline_clean) {
