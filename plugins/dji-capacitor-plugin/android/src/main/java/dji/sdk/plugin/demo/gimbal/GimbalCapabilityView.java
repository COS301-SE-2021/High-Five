...
public class GimbalCapabilityView extends LinearLayout implements View.OnClickListener, PresentableView {
    ...
    protected void onAttachedToWindow() {
        ...
        DJISampleApplication.getEventBus().post(new DjiActivity.RequestStartFullScreenEvent());
        setupButtonsState();
    ...
    protected void onDetachedFromWindow() {
        DJISampleApplication.getEventBus().post(new DjiActivity.RequestEndFullScreenEvent());
        currentGimbalId = 0;
        tearDownListeners();
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_pitchMin) {
            rotateGimbalToMin((Button) v);
        } else if (id == R.id.btn_pitchMax) {
            rotateGimbalToMax((Button) v);
        } else if (id == R.id.btn_yawMin) {
            rotateGimbalToMin((Button) v);
        } else if (id == R.id.btn_yawMax) {
            rotateGimbalToMax((Button) v);
        } else if (id == R.id.btn_rollMin) {
            rotateGimbalToMin((Button) v);
        } else if (id == R.id.btn_rollMax) {
            rotateGimbalToMax((Button) v);
        ...
        } else if (id == R.id.video_feeder_left_fpv) {
            onClickLeftAndFpvBtn();
        } else if (id == R.id.video_feeder_right_fpv) {
            onClickRightAndFpvBtn();
        } else if (id == R.id.video_feeder_left_right) {
