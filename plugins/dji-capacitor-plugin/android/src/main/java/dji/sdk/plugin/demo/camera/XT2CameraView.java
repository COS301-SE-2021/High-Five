...
import dji.sdk.plugin.SeekBarValueChangeListener;
import dji.sdk.plugin.utils.ToastUtils;
import dji.sdk.plugin.utils.VideoFeedView;
import dji.sdk.plugin.view.PopupSeekBar;
...
public class XT2CameraView extends LinearLayout implements View.OnClickListener, PresentableView {
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.btn_shoot_photo) {
            setSinglePhotoMode();
        } else if (id == R.id.btn_get_storage_location) {
            isSDCardInserted();
        } else if (id == R.id.btn_get_remaining_photo_count) {
            getPhotoCount();
        }
    }
    ...
    protected void onAttachedToWindow() {
        ...
        DJISampleApplication.getEventBus().post(new DjiActivity());
    }
