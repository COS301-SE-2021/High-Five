package dji.sdk.plugin.demo.keymanager;
...
public class KeyManagerView extends RelativeLayout implements PresentableView, View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if (id == R.id.component_spinner) {
            updateComponent(i);
        } else if (id == R.id.sub_component_spinner) {
            updateSubComponent(i);
        } else if (id == R.id.component_index_spinner) {
            updateComponentIdex(i);
        } else if (id == R.id.key_interface_spinner) {
    ...
    public void onClick(View view) {
        ...
        int id = view.getId();
        if (id == R.id.get_value_btn) {
            getValue();
        } else if (id == R.id.set_value_btn) {
            setValue();
        } else if (id == R.id.listen_key_btn) {
            if (isKeyListened) {
                isKeyListened = false;
                unListenKey();
            } else {
