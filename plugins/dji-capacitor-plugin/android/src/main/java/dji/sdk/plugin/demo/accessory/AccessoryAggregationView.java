package dji.sdk.plugin.demo.accessory;
...
import dji.sdk.plugin.audiohandler.AudioRecorderHandler;
...
public class AccessoryAggregationView extends LinearLayout implements View.OnClickListener, PresentableView {
    ...
    @Subscribe
    public void onConnectivityChange(DjiActivity.ConnectivityChangeEvent event) {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_beacon_enabled) {
            enableBeacon();
        } else if (id == R.id.btn_spotlight_enabled) {
            enableSpotlight();
        } else if (id == R.id.btn_set_spotlight_brightness) {
            setSpotlightBrightness();
        } else if (id == R.id.btn_set_speaker_volume) {
            setSpeakerVolume();
        } else if (id == R.id.btn_set_speaker_play_mode) {
            setPlayMode();
        } else if (id == R.id.btn_stop_playing) {
            stopPlaying();
