...
class MultipleLensCameraView(context: Context) : LinearLayout(context), View.OnClickListener,
    ...
    override fun onAttachedToWindow() {
        ...
        DJISampleApplication.getEventBus().post(DjiActivity.RequestStartFullScreenEvent())
    }

    override fun onDetachedFromWindow() {
        DJISampleApplication.getEventBus().post(DjiActivity.RequestEndFullScreenEvent())
        tearDownListeners()
